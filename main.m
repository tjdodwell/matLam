...
bnd_left  = [msh.lhs; msh.lhs + msh.nnod; msh.lhs + 2 * msh.nnod; msh.lhs + 3 * msh.nnod; msh.lhs + 4 * msh.nnod];
bnd_right = [msh.rhs; msh.rhs + msh.nnod; msh.rhs + 2 * msh.nnod; msh.rhs + 3 * msh.nnod; msh.rhs + 4 * msh.nnod];
